...
# nl4dv_instance.render_vis(query='show me the correlation between average budget and genre')
nl4dv_instance.render_vis('show me the correlation between average budget and average genre')
